        ...
        <div className=" hero my-20 ">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='text-white'>
                    ...
                    <p className="py-6">Pure Perfume is a warehouse website of sensitive products like perfume. It's created by reactJS with react-route.  </p>
                    ...
                    <div className='mt-9'>
                        ...
                        <button className="btn btn-sm btn-outline btn-secondary animate-bounce  mr-4 font-bold"> <a href='https://assignment12-2fdc9.web.app/' target='_blank'><AiOutlineCloudServer className='h-4 w-4 '></AiOutlineCloudServer></a> </button>
                    </div>
